 ...
 *
 * This is a hacky starting point; later we can do segmentation (person parsing)
 * to protect face/hair/hands + edit only clothing pixels.
 */
...
export default function Home() {
  ...
  async function generate() {
    ...
    // ✅ Always proxy through /api/img so it renders reliably
  ...
  return (
    <>
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        @media (max-width: 860px) {
          .root { grid-template-columns: 1fr; padding: 0 20px; }
        }
      ...
      <div className="root">
          ...
          {builtPrompt && (
            <div>
              ...
              <div className="prompt-preview">
                {selectedChips.map((c) => (
                  <span key={c} className="chip-inline">
                    {c}
                  </span>
                ))}
                {customPrompt.trim() && (
              ...
              {status === "done" && resultUrl ? (
                ...
                <div className="result-empty">
                  ...
                  <p className="result-empty-sub">
                    Add a photo and choose your style to see the magic.
                  </p>
                </div>
              )}
            </div>
        ...
        <footer className="footer">Atelier AI · Powered by your imagination · API keys are server-side only</footer>
      </div>
    </>
  );
}
